...
class Dagos_Letters_Activator {
	...
	private static function create_tables() {
		...
		$sql = "CREATE TABLE $table_name (
				...
				letter_name tinytext NOT NULL,
				letter_email varchar(100) DEFAULT '' NOT NULL,
				...
				letter_complete varchar(20)  DEFAULT '0' NOT NULL,
				letter_represent tinytext NOT NULL,		
				letter_district tinytext NOT NULL,		
				letter_meeting_date tinytext NOT NULL,	
				PRIMARY KEY (id)
		) $charset_collate";
